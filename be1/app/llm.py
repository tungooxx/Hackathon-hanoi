...
- Nếu khách nói muốn chốt, đặt mua hoặc mua ngay một mẫu cụ thể: đặt wants_checkout=true. Đây là yêu cầu
  tạo đơn prototype, không chỉ là yêu cầu xem thông tin chi tiết.
